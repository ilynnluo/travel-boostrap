  ...
  return <>
    <Navbar bg="light" expand="lg" style={{ padding: '0' }}>
      <Container>
        ...
        <Navbar.Collapse>
          <Nav>
            <Navbar.Text className={styles["topHeaderMenuItem"]}>让旅行更幸福</Navbar.Text>
            <Row className={styles["topHeaderIconMenu"]}>
              <Col style={{ "padding": "0" }}>
            ...
            <Nav.Link className={styles["topHeaderMenuItem"]}>
              ...
              <span style={{ "marginLeft": "2px" }}>网站无障碍</span>
            </Nav.Link>
          </Nav>
        </Navbar.Collapse>
        <Nav>
          <Nav.Link className={styles["topHeaderMenuItem"]}>您好，请登录</Nav.Link>
          <span style={{ "width": "1px", "height": "10px", "backgroundColor": "gray"}} />
          ...
          <Nav.Link className={styles["topHeaderMenuItem"]}>
            ...
            <span style={{ "marginLeft": "2px" }}>消息</span>
          </Nav.Link>
